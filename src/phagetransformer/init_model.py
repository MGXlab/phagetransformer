...
MODEL_FILES = [
    {
        ...
        'url': 'https://github.com/MGXlab/phagetransformer/releases/download/v0.2.0/best_aggregator.pt',
        'sha256': 'a645b1e06d8ba9d5b8aa9abe6d49ad7ac61aaf1f8d1e79043d5878e0f8dc6159',
        'size_mb': 80,
    },
    {
        'filename': 'ood_mahalanobis.npz',
        'url': 'https://github.com/MGXlab/phagetransformer/releases/download/v0.2.0/ood_mahalanobis.npz',
        'sha256': 'f3163d72a699c2581338d708d6d937769d756989730986ebefa539bd4a719989',
        'size_mb': 4,
    },
    {
        'filename': 'calibration.json',
        'url': 'https://github.com/MGXlab/phagetransformer/releases/download/v0.2.0/calibration.json',
